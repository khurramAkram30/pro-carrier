...
const mapResponse = (response: any): VerifyDeliveryOptionsResponse => { throw new NotImplementedError(); };

export const VerifyDeliveryOptions = async (request: VerifyDeliveryOptionsRequest): Promise<VerifyDeliveryOptionsResponse> => {
