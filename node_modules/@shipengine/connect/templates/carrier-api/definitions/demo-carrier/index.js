...
const { NextDayAir, BudgetService } = require("./shipping-services");
const { RegistrationFormSchema } = require("./registration-form");
const { SettingsFormSchema } = require("./settings-form");
...
module.exports.DemoCarrier = {
  ...
  if (_useNativeRating) { %>
  NativeRating: {
    DefaultRateCardId: "default-rate-card",
    Path: join(__dirname, "../../../data/<%- _appName %>"),
    RateCards: [
      {
  ...
  ShippingServices: [NextDayAir, BudgetService],
  ShippingOptions: {
