...
exports.VoidLabelMapping = exports.mapGetShipment = exports.isInternationalOrDomestic = exports.mapRequest = void 0;
...
const getShipmentInvoice = (request, response) => {
    return {
        ...
        Command: constants_1.COMMANDS.GetShipment,
...
const orderShipment = (data) => ({
    ...
    Command: constants_1.COMMANDS.OrderShipments,
...
const getCustomsDuty = (packageCustoms, ser_code) => {
    var _a, _b;
    const termsOfTradeCode = (_b = (_a = packageCustoms === null || packageCustoms === void 0 ? void 0 : packageCustoms.terms_of_trade_code) === null || _a === void 0 ? void 0 : _a.toUpperCase()) !== null && _b !== void 0 ? _b : "";
