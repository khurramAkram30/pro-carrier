...
const getCustoms = (packageCustoms) => {
    ...
    customItem.map((val, index) => {
        var _a, _b, _c;
        totalValue += Number((_b = (_a = customItem[index]) === null || _a === void 0 ? void 0 : _a.value) === null || _b === void 0 ? void 0 : _b.amount) * Number((_c = customItem[index]) === null || _c === void 0 ? void 0 : _c.quantity);
    });
    return totalValue;
};
...
const getCustomsDuty = (packageCustoms, ser_code) => {
    const termsOfTradeCode = packageCustoms.terms_of_trade_code.toUpperCase();
    if (termsOfTradeCode === constants_1.TRADE_CODE.DDP) {
        return constants_1.TRADE_CODE.DDP;
    }
    if ((ser_code.toUpperCase() === constants_1.SERVICE_API_CODES.ProCarrierParcelPlus || ser_code === constants_1.SERVICE_API_CODES.ProCarrierParcelPlusInternational) &&
        ...
        return constants_1.TRADE_CODE.DDU;
    }
};
...
const getProduct = (packageCustoms) => {
    ...
    content.forEach((customItem) => {
        ...
        let items = {
            ...
            HsCode: parseInt(customItem === null || customItem === void 0 ? void 0 : customItem.harmonized_tariff_code),
