...
const Register = async (request) => {
    ...
    const mappedRequest = (0, map_request_1.mapRequest)(registrationInfo);
    const response = await (0, api_communicator_1.ProcessRequest)(mappedRequest, constants_1.CarrierOperation.Register);
    (0, utils_1.checkCarrierError)(response);
