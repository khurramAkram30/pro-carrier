...
exports.HandleError = exports.getCustomError = exports.getLabelFormat = exports.getWeightUnit = exports.getWeight = exports.getAddress = exports.getConsigneeAddress = exports.getSenderAddress = exports.getName = exports.getCommand = exports.getAuthentication = void 0;
...
const getWeight = (pakg) => {
    if (pakg.weight_details.source_weight_unit === connect_carrier_api_1.WeightUnit.Pounds) {
        return pakg.weight_details.source_weight;
    }
    else if (pakg.weight_details.source_weight_unit === connect_carrier_api_1.WeightUnit.Kilograms) {
        return pakg.weight_details.source_weight;
    }
    else {
...
const HandleError = (error) => {
    ...
    if (error === null || error === void 0 ? void 0 : error.Error) {
        errorCode.push({
            ...
            message: baseError + "Error Code: " + (error === null || error === void 0 ? void 0 : error.ErrorLevel) + ", " + "Error Message: " + (error === null || error === void 0 ? void 0 : error.Error)
        });
        throw new connect_runtime_1.ExternalServerError(baseError, errorCode);
    }
};
