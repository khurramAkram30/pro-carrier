...
describe('Check service definitions properties - Demo Service', () => {
    test('Check Id', () => {
        ...
        //Assert
        expect(result).toBe('d0eab36d-3e0a-43a7-b304-54ec82e8cb28');
    });
    ...
    test('Check Name', () => {
        ...
        //Assert
        expect(result).toBe('Pro Carrier Parcel Express International');
    });
    ...
    test('Check ApiCode', () => {
        ...
        //Assert
        expect(result).toBe('procarrier_pcpe_intl');
    });
    ...
    test('Check Abbreviation', () => {
        ...
        //Assert
        expect(result).toBe('pc_parcel_exp_intl');
    });
